...
export const feedback: Feedback[] = [
  ...
  },
  {
    ...
    rate: 4.6,
    img: tjay,
    msg: " Shallom is a talented full-stack developer with endless ideas, but his constant stream of new concepts often complicates things. His tendency to add unnecessary features to projects creates extra work and disrupts progress. Instead of moving forward, we're constantly adjusting to his latest vision, making everything feel more chaotic and frustrating."
  },
  {
    index: 5,
